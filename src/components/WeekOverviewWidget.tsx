...
import {getDayNumber, getShortDayInHumanLanguage, getShortMonthInHumanLanguage,} from '../utils/date-formatter';
import {DailyWeatherDetails, WeatherData} from "../interfaces/weather-data.interface";
